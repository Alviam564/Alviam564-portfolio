      ...
      <div className="relative">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="blue dark:text-orange-600 text-l md:text-3xl flex justify-center mb-4 gap-2">
            <a href="https://github.com/Alviam564" target="_blank" 
            ...
            <a href="https://linkedin.com/in/william-alvarez-145228335" target="_blank" 
            ...
            <a href="/assets/William Alvarez Rodas Resume.pdf"  target="_blank" 
